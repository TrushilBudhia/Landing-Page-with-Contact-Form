...
## Answer - use the hover style e.g. a:hover { } - the background color, or text color or other styling can be applied to the element when the cursor hovers over it.
